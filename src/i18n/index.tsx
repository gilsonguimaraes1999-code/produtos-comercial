...
const pt = {
  loadUsersError: 'Não foi possível carregar os usuários. Tente novamente.',
  siteName: 'Comercial Produtos',
  siteDescription: 'Catálogo comercial de produtos.',
  appTitle: '',
  access: 'Acessar',
  viewCatalog: 'Visualizador',
  viewer: 'Visualizador',
  viewerAccessTitle: 'Visualizar catálogo',
  viewerAccessHint: 'Escolha uma cidade para consultar seus produtos e valores em modo somente leitura.',
  enterAsViewer: 'Visualizar produtos',
  viewerCityRequired: 'Selecione uma cidade para visualizar.',
  ...
  activateAccount: 'Primeiro acesso',
  activateAccountTitle: 'Ativar conta',
  activationHint: 'Use seu usuário e o código recebido para definir sua senha definitiva.',
  activationCode: 'Código de ativação',
  activationCodePlaceholder: 'Código de 10 caracteres',
  activationCodeRequired: 'Informe o código de ativação.',
  newPassword: 'Nova senha',
  confirmPassword: 'Confirmar senha',
  passwordsDoNotMatch: 'As senhas não coincidem.',
  activate: 'Ativar conta',
  activationSuccess: 'Conta ativada. Agora você já pode entrar.',
  activationFailed: 'Não foi possível ativar a conta.',
  activationNotAvailable: 'A ativação não está disponível para este usuário.',
  accountAlreadyActive: 'Esta conta já foi ativada.',
  activationCodeInvalid: 'O código de ativação é inválido.',
  activationCodeExpired: 'O código expirou. Solicite um novo código ao Owner.',
  activationAttemptsExceeded: 'Limite de tentativas excedido. Solicite um novo código ao Owner.',
  ...
  accessRequestTrackingPending: 'Solicitação pendente. Aguardando análise do administrador.',
  accessRequestTrackingApproved: 'Solicitação aprovada. Use o primeiro acesso para ativar sua conta.',
  accessRequestTrackingRejected: 'Solicitação rejeitada. Revise os dados e envie um novo pedido.',
  newAccessRequest: 'Nova solicitação',
  fillAccessRequest: 'Preencha nome, usuário, senha e cidade.',
  passwordMinLength: 'A senha precisa ter no mínimo 8 caracteres.',
  accessNameRequired: 'Informe o nome de exibição.',
  accessUsernameRequired: 'Informe o nome de usuário.',
  accessPasswordRequired: 'Informe uma senha.',
  accessCityRequired: 'Selecione pelo menos uma cidade.',
  usernameInvalid: 'O nome de usuário não pode conter espaços.',
  usernameInUse: 'Já existe uma conta com este nome de usuário.',
  accessRequestPending: 'Já existe uma solicitação pendente para este usuário.',
  invalidAccessCity: 'Uma das cidades selecionadas não está mais disponível. Selecione novamente.',
  ...
  loadingCreatedCities: 'Buscando as cidades criadas antes de abrir a seleção.',
  noCitiesAvailable: 'Nenhuma cidade está disponível no momento.',
  loadingCityProducts: 'Carregando categorias e produtos da cidade selecionada.',
  ...
  manageRolesAndCities: 'Gerencie cargos, ações permitidas e o acesso por cidade.',
  userSearchPlaceholder: 'Pesquisar por nome, e-mail, cargo ou cidade...',
  userFilters: 'Filtros de usuários',
  allCities: 'Todas as cidades',
  generalAccessCompatibility: 'Acesso geral / compatibilidade',
  ...
  creationStartDate: 'Data inicial de criação',
  creationEndDate: 'Data final de criação',
  clearFilters: 'Limpar filtros',
  usersFound: '{{visible}} de {{total}} usuários encontrados',
  period: 'Período',
  beginning: 'início',
  today: 'hoje',
  ...
  allCitiesCompatibility: 'Todas as cidades (compatibilidade)',
  noDateRegistered: 'Sem data registrada',
  requestedCities: 'Cidades solicitadas',
  requestedCitiesBy: 'Cidades solicitadas por {{name}}',
  citiesLabel: 'Cidades',
  accountCreated: 'Conta criada',
  noUsersFound: 'Nenhum usuário encontrado.',
  allowedCities: 'Cidades permitidas',
  allowedCitiesHint: 'O cargo define o que a pessoa faz; as cidades definem onde ela pode visualizar e atuar.',
  backToCatalog: 'Voltar ao catálogo',

  standardDescription: 'Descrição Padrão',
  standardDescriptionHint: 'Crie mais de um HTML por categoria e mantenha versões em PT, EN e ES.',
  newDescriptionTemplate: 'Novo padrão',
  noDescriptionTemplates: 'Nenhum padrão criado para esta categoria.',
  templateName: 'Nome do padrão',
  templateOrder: 'Ordem',
  activeTemplate: 'Padrão ativo',
  availableVariables: 'Variáveis disponíveis',
  saveTemplate: 'Salvar padrão',
  templateSaved: 'Padrão salvo com sucesso.',
  templateDeleted: 'Padrão excluído com sucesso.',
  ...
  accessRequestsCityHint: 'Visualize e responda apenas às solicitações das cidades sob sua responsabilidade.',
  filterRequestsByCity: 'Filtrar solicitações por cidade',
  allAllowedCities: 'Todas as cidades permitidas',
  loadingAccessRequests: 'Carregando solicitações...',
  noPendingAccessRequestsForCity: 'Nenhuma solicitação pendente para a cidade selecionada.',
  accessRequestPermission: 'Permissão de solicitações de acesso',
  accessRequestPermissionHint: 'Permite analisar e responder solicitações, sem alterar cargos ou permissões.',
  manageAssignedCityRequests: 'Gerenciar solicitações das cidades permitidas',
  ...
  status: 'Status',
  viewAccessDetails: 'Visualizar detalhes do acesso',
  accessDetails: 'Detalhes do acesso',
  approvedCities: 'Cidades configuradas na aprovação',
  noApprovedCitiesRegistered: 'Nenhuma cidade aprovada registrada.',
  requestedAt: 'Solicitado em',
  reviewedAt: 'Analisado em',
  reviewedBy: 'Analisado por',
  ...
  apiNotConfiguredTitle: 'Supabase não configurado',
  apiNotConfiguredDescription: 'Crie o arquivo .env na raiz do projeto e informe a URL e a chave pública do Supabase.',
  apiNotConfiguredCode: 'VITE_SUPABASE_URL=https://SEU_PROJETO.supabase.co\nVITE_SUPABASE_ANON_KEY=SUA_CHAVE_PUBLICA',
  apiNotConfigured: 'Configure VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY no arquivo .env.',
  ...
  editConflictTitle: 'Conflito de edição', editConflictMessage: 'Outra pessoa alterou {{entity}} depois que você abriu este formulário. Seu rascunho foi preservado.', loadLatestVersion: 'Carregar versão mais recente', copyMyChanges: 'Copiar minhas alterações', keepEditing: 'Continuar editando', orderConflictMessage: 'A ordem desta lista mudou. Recarregue a versão mais recente e tente novamente.',
...
const en: TranslationTable = {
  ...
  siteName: 'Commercial Products', siteDescription: 'Catálogo comercial de produtos.', appTitle: '', access: 'Access', viewCatalog: 'Viewer', viewer: 'Viewer', viewerAccessTitle: 'View catalog', viewerAccessHint: 'Choose a city to view its products and prices in read-only mode.', enterAsViewer: 'View products', viewerCityRequired: 'Select a city to view.', backToLogin: 'Back to login', username: 'Username', password: 'Password', continue: 'Continue', enter: 'Sign in', backToUser: 'Back to username', backToLobby: 'Back to lobby', rememberAccess: 'Remember access', userRequired: 'Enter your username.', invalidCredentials: 'Credentials not recognized.', activateAccount: 'First access', activateAccountTitle: 'Activate account', activationHint: 'Use your username and activation code to set your permanent password.', activationCode: 'Activation code', activationCodePlaceholder: '10-character code', activationCodeRequired: 'Enter the activation code.', newPassword: 'New password', confirmPassword: 'Confirm password', passwordsDoNotMatch: 'Passwords do not match.', activate: 'Activate account', activationSuccess: 'Account activated. You can now sign in.', activationFailed: 'The account could not be activated.', activationNotAvailable: 'Activation is not available for this username.', accountAlreadyActive: 'This account has already been activated.', activationCodeInvalid: 'The activation code is invalid.', activationCodeExpired: 'The code has expired. Ask the Owner for a new code.', activationAttemptsExceeded: 'Attempt limit exceeded. Ask the Owner for a new code.', showPassword: 'Show password', hidePassword: 'Hide password', requestAccess: 'Request access', requestAccessTitle: 'Request access', requestAccessSubtitle: 'Fill in your details. An administrator will review and assign your role.', displayName: 'Display name', displayNamePlaceholder: 'Your name', requestUsernamePlaceholder: 'no_spaces', requestPasswordHint: 'Minimum 8 characters', sendAccessRequest: 'Send request', alreadyHaveAccount: 'Already have an account?', accessRequestSent: 'Request sent. Wait for administrator approval.', fillAccessRequest: 'Fill in name, username, password and city.', passwordMinLength: 'Password must be at least 8 characters.',
  accessRequestTrackingPending: 'Access request pending. Waiting for administrator review.', accessRequestTrackingApproved: 'Access request approved. Use first access to activate your account.', accessRequestTrackingRejected: 'Access request rejected. Review the details and send a new request.', newAccessRequest: 'New request',
  accessNameRequired: 'Enter your display name.', accessUsernameRequired: 'Enter a username.', accessPasswordRequired: 'Enter a password.', accessCityRequired: 'Select at least one city.', usernameInvalid: 'The username cannot contain spaces.', usernameInUse: 'An account with this username already exists.', accessRequestPending: 'There is already a pending request for this username.', invalidAccessCity: 'One of the selected cities is no longer available. Select again.',
  categories: 'Categories', products: 'Products', product: 'Product', users: 'Users', category: 'Category', owner: 'Owner', commercial: 'Commercial', loadingCatalog: 'Loading catalog...', loadingCities: 'Loading cities...', loadingCreatedCities: 'Fetching the created cities before opening the selection.', noCitiesAvailable: 'No cities are currently available.', loadingCityProducts: 'Loading categories and products from the selected city.', noCategoryFound: 'No categories found.', noCategoryCreated: 'No categories created', ownerCreateFirst: 'The Owner must create the first category before adding products.', createFirstCategory: 'Create first category', availableOne: '1 product available in this category.', availableMany: '{{count}} products available in this category.', searchProductIn: 'Search products in {{category}}...', catalogBreadcrumb: 'Catalog · {{category}}', clearSearch: 'Clear search', emptyCategory: 'No products in this category.', emptyCategoryOwnerHint: 'Drag a product here or create a new one.', show: 'Show', tenPerPage: '10 per page', allProducts: 'All products', sort: 'Sort', defaultOrder: 'Standard', priceLowToHigh: 'Lowest price', priceHighToLow: 'Highest price', gridView: 'Grid', listView: 'List', showGridView: 'Show as grid', showListView: 'Show as list', productFilters: 'Product filters', standardizeDescriptions: 'Standardize descriptions', translateProducts: 'Translate products', translatingProducts: 'Translating products...', productsTranslated: 'Products translated successfully.', productsAlreadyTranslated: 'Products already synchronized in this language.', updateMansionPhotos: 'Update photos', updatingMansionPhotos: 'Updating photos...', mansionPhotosUpdated: 'Mansion photos updated successfully.', mansionPhotosAlreadyUpdated: 'Mansions with known photos are already updated.',
  ...
  manageRolesAndCities: 'Manage roles, permitted actions, and access by city.', userSearchPlaceholder: 'Search by name, email, role, or city...', userFilters: 'User filters', allCities: 'All cities', generalAccessCompatibility: 'General access / compatibility', filterByCity: 'Filter by city', allRoles: 'All roles', filterByRole: 'Filter by role', createdFrom: 'Created from', createdTo: 'Created until', creationStartDate: 'Creation start date', creationEndDate: 'Creation end date', clearFilters: 'Clear filters', usersFound: '{{visible}} of {{total}} users found', period: 'Period', beginning: 'beginning', today: 'today', previousMonth: 'Previous month', nextMonth: 'Next month', clearDate: 'Clear', datePlaceholder: 'mm/dd/yyyy', allCitiesCompatibility: 'All cities (compatibility)', noDateRegistered: 'No date registered', requestedCities: 'Requested cities', requestedCitiesBy: 'Cities requested by {{name}}', citiesLabel: 'Cities', accountCreated: 'Account created', noUsersFound: 'No users found.', allowedCities: 'Allowed cities', allowedCitiesHint: 'The role defines what the person can do; cities define where they can view and act.', backToCatalog: 'Back to catalog',
  standardDescription: 'Standard Description', standardDescriptionHint: 'Create multiple HTML templates per category and maintain PT, EN, and ES versions.', newDescriptionTemplate: 'New template', noDescriptionTemplates: 'No templates created for this category.', templateName: 'Template name', templateOrder: 'Order', activeTemplate: 'Active template', availableVariables: 'Available variables', saveTemplate: 'Save template', templateSaved: 'Template saved successfully.', templateDeleted: 'Template deleted successfully.',
  exhibitorPermissions: 'Site permissions', permissionsHint: 'Owner can edit everything. Commercial can only view.', newAccount: 'New account', loadingUsers: 'Loading users...', editAccount: 'Edit account', name: 'Name', role: 'Role', activeAccount: 'Active account', saveAccount: 'Save account', closeSettings: 'Close settings', fillNameUser: 'Enter a name and username.', definePassword: 'Set a password for the new account.', saveUserError: 'Error saving user.', userSaved: 'User saved successfully.', deleteUserError: 'Error deleting user.', leaveEmptyPassword: 'Leave blank to keep current password', requiredPassword: 'Password required', active: 'Active', inactive: 'Inactive', editUserAction: 'Edit user {{name}}', deleteUserAction: 'Delete user {{name}}', accessRequests: 'Access requests', accessRequestsHint: 'Pending requests and removed account history.', accessPendingHint: 'Only pending requests waiting for a response.', accessRequestsCityHint: 'View and respond only to requests from cities under your responsibility.', filterRequestsByCity: 'Filter requests by city', allAllowedCities: 'All allowed cities', loadingAccessRequests: 'Loading requests...', noPendingAccessRequestsForCity: 'No pending requests for the selected city.', accessRequestPermission: 'Access request permission', accessRequestPermissionHint: 'Allows reviewing and responding to requests without changing roles or permissions.', manageAssignedCityRequests: 'Manage requests from allowed cities', accessHistory: 'History', accessHistoryTitle: 'Access history', accessHistoryHint: 'Approved, rejected, and removed accounts stay here.', noAccessRequests: 'No requests registered.', noPendingAccessRequests: 'No pending requests.', noAccessHistory: 'No history registered.', approveAccess: 'Approve access', rejectAccess: 'Reject access', accessStatusPending: 'Pending', accessStatusApproved: 'Approved', accessStatusRejected: 'Rejected', accessStatusRemoved: 'Removed', status: 'Status', viewAccessDetails: 'View access details', accessDetails: 'Access details', approvedCities: 'Cities configured at approval', noApprovedCitiesRegistered: 'No approved cities registered.', requestedAt: 'Requested at', reviewedAt: 'Reviewed at', reviewedBy: 'Reviewed by',
  ...
  apiNotConfiguredTitle: 'Supabase is not configured', apiNotConfiguredDescription: 'Create a .env file in the project root and add the Supabase URL and public key.', apiNotConfiguredCode: 'VITE_SUPABASE_URL=https://YOUR_PROJECT.supabase.co\nVITE_SUPABASE_ANON_KEY=YOUR_PUBLIC_KEY', apiNotConfigured: 'Set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in the .env file.', requestTimeout: 'The server took too long to respond. Try again.', networkError: 'Could not connect to the server.', invalidResponse: 'Invalid server response.', requestFailed: 'The request could not be completed.', syncError: 'Could not synchronize the catalog.', sessionExpired: 'Your session has expired. Sign in again.', ownerRequired: 'Only the Owner role can perform this action.', categoryNotFound: 'Category not found.', productNotFound: 'Product not found.', userNotFound: 'User not found.', invalidCurrency: 'Invalid currency.', imageRequired: 'Add at least one image.', invalidImageContent: 'One of the images has no valid content.', uploadFailed: 'Image upload failed.',
  editConflictTitle: 'Edit conflict', editConflictMessage: 'Someone else changed {{entity}} after you opened this form. Your draft has been preserved.', loadLatestVersion: 'Load latest version', copyMyChanges: 'Copy my changes', keepEditing: 'Keep editing', orderConflictMessage: 'This list order changed. Load the latest version and try again.',
...
const es: TranslationTable = {
  loadUsersError: 'No se pudieron cargar los usuarios. Inténtalo de nuevo.',
  siteName: 'Productos Comerciales', siteDescription: 'Catálogo comercial de produtos.', appTitle: '', access: 'Acceder', viewCatalog: 'Visualizador', viewer: 'Visualizador', viewerAccessTitle: 'Ver catálogo', viewerAccessHint: 'Elige una ciudad para consultar sus productos y precios en modo de solo lectura.', enterAsViewer: 'Ver productos', viewerCityRequired: 'Selecciona una ciudad para visualizar.', backToLogin: 'Volver al inicio de sesión', username: 'Usuario', password: 'Contraseña', continue: 'Continuar', enter: 'Entrar', backToUser: 'Volver al usuario', backToLobby: 'Volver al lobby', rememberAccess: 'Recordar acceso', userRequired: 'Introduce el usuario.', invalidCredentials: 'Credenciales no reconocidas.', activateAccount: 'Primer acceso', activateAccountTitle: 'Activar cuenta', activationHint: 'Usa tu usuario y el código de activación para definir tu contraseña permanente.', activationCode: 'Código de activación', activationCodePlaceholder: 'Código de 10 caracteres', activationCodeRequired: 'Introduce el código de activación.', newPassword: 'Nueva contraseña', confirmPassword: 'Confirmar contraseña', passwordsDoNotMatch: 'Las contraseñas no coinciden.', activate: 'Activar cuenta', activationSuccess: 'Cuenta activada. Ya puedes entrar.', activationFailed: 'No se pudo activar la cuenta.', activationNotAvailable: 'La activación no está disponible para este usuario.', accountAlreadyActive: 'Esta cuenta ya fue activada.', activationCodeInvalid: 'El código de activación no es válido.', activationCodeExpired: 'El código ha caducado. Solicita uno nuevo al Owner.', activationAttemptsExceeded: 'Se superó el límite de intentos. Solicita un código nuevo al Owner.', showPassword: 'Mostrar contraseña', hidePassword: 'Ocultar contraseña', requestAccess: 'Solicitar acceso', requestAccessTitle: 'Solicitar acceso', requestAccessSubtitle: 'Completa tus datos. Un administrador revisará y definirá tu cargo.', displayName: 'Nombre visible', displayNamePlaceholder: 'Tu nombre', requestUsernamePlaceholder: 'sin_espacios', requestPasswordHint: 'Mínimo 8 caracteres', sendAccessRequest: 'Enviar solicitud', alreadyHaveAccount: '¿Ya tienes cuenta?', accessRequestSent: 'Solicitud enviada. Espera la aprobación del administrador.', fillAccessRequest: 'Completa nombre, usuario, contraseña y ciudad.', passwordMinLength: 'La contraseña debe tener al menos 8 caracteres.',
  accessRequestTrackingPending: 'Solicitud de acceso pendiente. Esperando la revisión del administrador.', accessRequestTrackingApproved: 'Solicitud de acceso aprobada. Usa el primer acceso para activar tu cuenta.', accessRequestTrackingRejected: 'Solicitud de acceso rechazada. Revisa los datos y envía una nueva solicitud.', newAccessRequest: 'Nueva solicitud',
  accessNameRequired: 'Introduce el nombre visible.', accessUsernameRequired: 'Introduce un nombre de usuario.', accessPasswordRequired: 'Introduce una contraseña.', accessCityRequired: 'Selecciona al menos una ciudad.', usernameInvalid: 'El nombre de usuario no puede contener espacios.', usernameInUse: 'Ya existe una cuenta con este nombre de usuario.', accessRequestPending: 'Ya existe una solicitud pendiente para este usuario.', invalidAccessCity: 'Una de las ciudades seleccionadas ya no está disponible. Selecciona nuevamente.',
  categories: 'Categorías', products: 'Productos', product: 'Producto', users: 'Usuarios', category: 'Categoría', owner: 'Propietario', commercial: 'Comercial', loadingCatalog: 'Cargando catálogo...', loadingCities: 'Cargando ciudades...', loadingCreatedCities: 'Buscando las ciudades creadas antes de abrir la selección.', noCitiesAvailable: 'No hay ciudades disponibles en este momento.', loadingCityProducts: 'Cargando categorías y productos de la ciudad seleccionada.', noCategoryFound: 'No se encontraron categorías.', noCategoryCreated: 'No hay categorías creadas', ownerCreateFirst: 'El Propietario debe crear la primera categoría antes de añadir productos.', createFirstCategory: 'Crear primera categoría', availableOne: '1 producto disponible en esta categoría.', availableMany: '{{count}} productos disponibles en esta categoría.', searchProductIn: 'Buscar productos en {{category}}...', catalogBreadcrumb: 'Catálogo · {{category}}', clearSearch: 'Limpiar búsqueda', emptyCategory: 'No hay productos en esta categoría.', emptyCategoryOwnerHint: 'Arrastra un producto aqué o crea uno nuevo.', show: 'Mostrar', tenPerPage: '10 por página', allProducts: 'Todos los productos', sort: 'Ordenar', defaultOrder: 'Estándar', priceLowToHigh: 'Precio más bajo', priceHighToLow: 'Precio más alto', gridView: 'Cuadrícula', listView: 'Lista', showGridView: 'Mostrar en cuadrícula', showListView: 'Mostrar en lista', productFilters: 'Filtros de productos', standardizeDescriptions: 'Estandarizar descripciones', translateProducts: 'Traducir productos', translatingProducts: 'Traduciendo productos...', productsTranslated: 'Productos traducidos correctamente.', productsAlreadyTranslated: 'Productos ya sincronizados en este idioma.', updateMansionPhotos: 'Actualizar fotos', updatingMansionPhotos: 'Actualizando fotos...', mansionPhotosUpdated: 'Fotos de mansiones actualizadas correctamente.', mansionPhotosAlreadyUpdated: 'Las mansiones con foto conocida ya están actualizadas.',
  ...
  manageRolesAndCities: 'Gestiona cargos, acciones permitidas y el acceso por ciudad.', userSearchPlaceholder: 'Buscar por nombre, correo, cargo o ciudad...', userFilters: 'Filtros de usuarios', allCities: 'Todas las ciudades', generalAccessCompatibility: 'Acceso general / compatibilidad', filterByCity: 'Filtrar por ciudad', allRoles: 'Todos los cargos', filterByRole: 'Filtrar por cargo', createdFrom: 'Creada desde', createdTo: 'Creada hasta', creationStartDate: 'Fecha inicial de creación', creationEndDate: 'Fecha final de creación', clearFilters: 'Limpiar filtros', usersFound: '{{visible}} de {{total}} usuarios encontrados', period: 'Período', beginning: 'inicio', today: 'hoy', previousMonth: 'Mes anterior', nextMonth: 'Mes siguiente', clearDate: 'Limpiar', datePlaceholder: 'dd/mm/aaaa', allCitiesCompatibility: 'Todas las ciudades (compatibilidad)', noDateRegistered: 'Sin fecha registrada', requestedCities: 'Ciudades solicitadas', requestedCitiesBy: 'Ciudades solicitadas por {{name}}', citiesLabel: 'Ciudades', accountCreated: 'Cuenta creada', noUsersFound: 'No se encontraron usuarios.', allowedCities: 'Ciudades permitidas', allowedCitiesHint: 'El cargo define lo que la persona puede hacer; las ciudades definen dónde puede visualizar y actuar.', backToCatalog: 'Volver al catálogo',
  standardDescription: 'Descripción Estándar', standardDescriptionHint: 'Crea varias plantillas HTML por categoría y mantén versiones en PT, EN y ES.', newDescriptionTemplate: 'Nueva plantilla', noDescriptionTemplates: 'No hay plantillas creadas para esta categoría.', templateName: 'Nombre de la plantilla', templateOrder: 'Orden', activeTemplate: 'Plantilla activa', availableVariables: 'Variables disponibles', saveTemplate: 'Guardar plantilla', templateSaved: 'Plantilla guardada correctamente.', templateDeleted: 'Plantilla eliminada correctamente.',
  exhibitorPermissions: 'Permisos del sitio', permissionsHint: 'El Propietario puede editar todo. Comercial solo puede visualizar.', newAccount: 'Nueva cuenta', loadingUsers: 'Cargando usuarios...', editAccount: 'Editar cuenta', name: 'Nombre', role: 'Cargo', activeAccount: 'Cuenta activa', saveAccount: 'Guardar cuenta', closeSettings: 'Cerrar configuración', fillNameUser: 'Completa el nombre y el usuario.', definePassword: 'Define una contraseña para la nueva cuenta.', saveUserError: 'Error al guardar el usuario.', userSaved: 'Usuario guardado correctamente.', deleteUserError: 'Error al eliminar el usuario.', leaveEmptyPassword: 'Déjalo vacío para mantener la contraseña actual', requiredPassword: 'Contraseña obligatoria', active: 'Activo', inactive: 'Inactivo', editUserAction: 'Editar usuario {{name}}', deleteUserAction: 'Eliminar usuario {{name}}', accessRequests: 'Solicitudes de acceso', accessRequestsHint: 'Solicitudes pendientes e historial de cuentas eliminadas.', accessPendingHint: 'Solo solicitudes pendientes esperando respuesta.', accessRequestsCityHint: 'Visualiza y responde solo solicitudes de las ciudades bajo tu responsabilidad.', filterRequestsByCity: 'Filtrar solicitudes por ciudad', allAllowedCities: 'Todas las ciudades permitidas', loadingAccessRequests: 'Cargando solicitudes...', noPendingAccessRequestsForCity: 'No hay solicitudes pendientes para la ciudad seleccionada.', accessRequestPermission: 'Permiso de solicitudes de acceso', accessRequestPermissionHint: 'Permite revisar y responder solicitudes sin cambiar cargos ni permisos.', manageAssignedCityRequests: 'Gestionar solicitudes de las ciudades permitidas', accessHistory: 'Historial', accessHistoryTitle: 'Historial de accesos', accessHistoryHint: 'Las cuentas aprobadas, rechazadas o eliminadas quedan aqué.', noAccessRequests: 'No hay solicitudes registradas.', noPendingAccessRequests: 'No hay solicitudes pendientes.', noAccessHistory: 'No hay historial registrado.', approveAccess: 'Aprobar acceso', rejectAccess: 'Rechazar acceso', accessStatusPending: 'Pendiente', accessStatusApproved: 'Aprobado', accessStatusRejected: 'Rechazado', accessStatusRemoved: 'Eliminado', status: 'Estado', viewAccessDetails: 'Ver detalles del acceso', accessDetails: 'Detalles del acceso', approvedCities: 'Ciudades configuradas en la aprobación', noApprovedCitiesRegistered: 'No hay ciudades aprobadas registradas.', requestedAt: 'Solicitado el', reviewedAt: 'Revisado el', reviewedBy: 'Revisado por',
  ...
  apiNotConfiguredTitle: 'Supabase no está configurado', apiNotConfiguredDescription: 'Crea un archivo .env en la raíz del proyecto e introduce la URL y la clave pública de Supabase.', apiNotConfiguredCode: 'VITE_SUPABASE_URL=https://TU_PROYECTO.supabase.co\nVITE_SUPABASE_ANON_KEY=TU_CLAVE_PUBLICA', apiNotConfigured: 'Configura VITE_SUPABASE_URL y VITE_SUPABASE_ANON_KEY en el archivo .env.', requestTimeout: 'El servidor tardó demasiado en responder. Inténtalo de nuevo.', networkError: 'No se pudo conectar con el servidor.', invalidResponse: 'Respuesta no válida del servidor.', requestFailed: 'No se pudo completar la solicitud.', syncError: 'No se pudo sincronizar el catálogo.', sessionExpired: 'Tu sesión ha caducado. Inicia sesión de nuevo.', ownerRequired: 'Solo el cargo Propietario puede realizar esta acción.', categoryNotFound: 'Categoría no encontrada.', productNotFound: 'Producto no encontrado.', userNotFound: 'Usuario no encontrado.', invalidCurrency: 'Moneda no válida.', imageRequired: 'Añade al menos una imagen.', invalidImageContent: 'Una de las imágenes no tiene contenido válido.', uploadFailed: 'Error al subir la imagen.',
  editConflictTitle: 'Conflicto de edición', editConflictMessage: 'Otra persona cambió {{entity}} después de que abriste este formulario. Tu borrador se ha conservado.', loadLatestVersion: 'Cargar la versión más reciente', copyMyChanges: 'Copiar mis cambios', keepEditing: 'Continuar editando', orderConflictMessage: 'El orden de esta lista cambió. Carga la versión más reciente e inténtalo de nuevo.',
...
const errorCodeToKey: Record<string, TranslationKey> = {
  ...
  ACTIVATION_NOT_AVAILABLE: 'activationNotAvailable',
  ...
  ACTIVATION_ATTEMPTS_EXCEEDED: 'activationAttemptsExceeded',
  ...
  ACCESS_NAME_REQUIRED: 'accessNameRequired',
  ACCESS_USERNAME_REQUIRED: 'accessUsernameRequired',
  ACCESS_PASSWORD_REQUIRED: 'accessPasswordRequired',
  ACCESS_CITY_REQUIRED: 'accessCityRequired',
  USERNAME_INVALID: 'usernameInvalid',
  USERNAME_IN_USE: 'usernameInUse',
  ACCESS_REQUEST_PENDING: 'accessRequestPending',
  INVALID_ACCESS_CITY: 'invalidAccessCity',
};
