...
const pt = {
  ...
  backupPageDescription: 'Gere e importe arquivos JSON do site. A planilha exibe o ID unico do backup e o horario criado.',
  ...
  backupInvalidFile: 'Arquivo de backup invalido.',
...
const es: TranslationTable = {
  ...
  resizeSidebar: 'Redimensionar menú lateral', moveCategory: 'Mover categoría', logout: 'Salir', menu: 'Menú', backup: 'Backup', backupSnapshotTitle: 'Guardar estado actual del sitio', backupSnapshotDescription: 'Genera un archivo JSON directamente en el sitio con categorías, productos, imágenes, precios, iconos, usuarios, cargos y configuraciones guardadas hasta este momento.', backupPageDescription: 'Genera e importa archivos JSON del sitio. La hoja muestra el ID unico del backup y la hora de creacion.', createBackupNow: 'Generar Backup', creatingBackup: 'Generando backup...', importBackup: 'Importar Backup', importingBackup: 'Importando backup...', backupCreated: 'Backup generado y descargado por el sitio.', backupInvalidFile: 'Archivo de backup invalido.', backupImportError: 'Error al importar backup.', downloadBackup: 'Descargar archivo', backupHistory: 'Backups registrados', backupHistoryEmpty: 'No hay backups registrados todavia.', backupError: 'Error al generar backup.', reorderCategories: 'Reordenando categorías...', movingProduct: 'Moviendo producto...', saveChanges: 'Guardar Cambios', discardChanges: 'Descartar Cambios', savingChanges: 'Guardando cambios...', changesSaved: 'Cambios guardados correctamente.', pendingChanges: 'Cambios pendientes', genericActionError: 'No se pudo completar la acción.', genericDeleteError: 'No se pudo completar la eliminación.',
